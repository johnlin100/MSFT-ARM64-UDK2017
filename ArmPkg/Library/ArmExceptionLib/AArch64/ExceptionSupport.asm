...
// Convert GNU assembler syntax to MSFT ARMASM64 syntax from AArch64/ExceptionSupport.S
//
...
$X_end
  ...
  MEND
    ...
    AREA ExceptionHandler, DATA, READONLY, ARM64, CODEALIGN, ALIGN=7
...
SynchronousExceptionSP0
  ExceptionEntry  EXCEPT_AARCH64_SYNCHRONOUS_EXCEPTIONS, SPx
  VECTOR_SPACE_PAD SynchronousExceptionSP0
  
IrqSP0
  ExceptionEntry  EXCEPT_AARCH64_IRQ, SPx
  VECTOR_SPACE_PAD IrqSP0

FiqSP0
  ExceptionEntry  EXCEPT_AARCH64_FIQ, SPx
  VECTOR_SPACE_PAD FiqSP0

SErrorSP0
  ExceptionEntry  EXCEPT_AARCH64_SERROR, SPx
...
//   )
    ...
    EL1_OR_EL2_OR_EL3 x28, %F1, %F2, %F3
